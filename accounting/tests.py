...
class HomeownershipHistoryTests(TestCase):
    ...
    def test_exclude_start_in_second_period(self):
        ...
        homeownership_history = HomeownershipHistory(real_estate=real_estate, water_description=water_desc17, count=4, start='2015-08-22')
        homeownership_history.save()
        homeownership_history = HomeownershipHistory(real_estate=real_estate, water_description=water_desc17, count=5, start='2015-08-28')
        homeownership_history.save()
    ...
    def test_two_kind_of_animals(self):
        ...
        homeownership_history = HomeownershipHistory(real_estate=real_estate, water_description=water_desc17, count=5, start='2015-08-28')
        homeownership_history.save()
        homeownership_history = HomeownershipHistory(real_estate=real_estate, water_description=water_desc15, count=3, start='2015-08-23')
        homeownership_history.save()
    ...
    def test_one_change_date_two_periods_for_all_kind_of_animals(self):
        ...
        homeownership_history = HomeownershipHistory(real_estate=real_estate, water_description=water_desc17, count=4, start='2015-08-22')
        homeownership_history.save()
        homeownership_history = HomeownershipHistory(real_estate=real_estate, water_description=water_desc15, count=3, start='2015-08-22')
        homeownership_history.save()
