...
from accounting.models import Period, Region, RealEstate, ServiceClient, ColdWaterNorm, DegreeOfImprovementsDwelling, ColdWaterReading, AnimalType, Animals, ColdWaterVolume, ColdWaterVolumeODN, Organization, ColdWaterNormODN, NormValidity, UserOrganization, Account, ResourceSupplyOrganization, TariffType, ColdWaterTariff 
...
def prepare_db_base():
    ...
    resource_apply_org = ResourceSupplyOrganization(name="Организация1", OGRN="001", INN="121")
    resource_apply_org.save()
    ...
    cold_water_tariff = ColdWaterTariff(type=tariff_type, resource_apply_org=resource_apply_org, value=1.2)
